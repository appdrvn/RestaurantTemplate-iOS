...
#pragma mark - set up pageControl
    [self addSubview:({
        ...
        pageControl.frame = CGRectMake([UIScreen mainScreen].bounds.size.width - 10 - (self.count * 13), scrollH - 10.0f - LCPageDistance, self.count * 13, 10.0f);
